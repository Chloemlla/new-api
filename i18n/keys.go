...
const (
	...
	MsgUserPendingApproval           = "user.pending_approval"
	MsgUserNotPendingApproval        = "user.not_pending_approval"
	MsgUserRegisteredPendingApproval = "user.registered_pending_approval"
...
const (
	...
	MsgOAuthLegacyBindingRefused = "oauth.legacy_binding_refused"
)
