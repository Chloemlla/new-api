...
func InitOptionMap() {
	...
	common.OptionMap["UserRegistrationApprovalEnabled"] = strconv.FormatBool(common.UserRegistrationApprovalEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "UserRegistrationApprovalEnabled":
			common.UserRegistrationApprovalEnabled = boolValue
